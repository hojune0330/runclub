...
const faqs: FAQ[] = [
  {
    ...
    a: '매주 수요일·금요일 저녁, 여의도 한강공원 문화의 광장에 모여 전문 코치와 함께 천천히·길게 달리는 러닝 클럽입니다. "슬로우 롱런(Slow Long Run)"은 숨이 차지 않을 속도로 오래 달리는 러닝 방식으로, 초보자도 무리 없이 따라올 수 있고 부상 위험이 낮으면서 심폐지구력은 확실히 올라갑니다. 혼자서는 꾸준히 못 하던 러닝을, 정해진 시간·장소·동료가 있으니 "헬스장 회원권"처럼 습관으로 만들 수 있습니다.',
  },
  {
    ...
    <div className="max-w-[960px]">
      ...
      <div className="mb-6">
        ...
        <p className="text-[13px] text-[var(--color-text-muted)]">
          매주 수·금 저녁 7시 30분, 여의도 문화의 광장에서 함께 달려요. 월 10,000원 · 한 달 8회.
        </p>
      </div>
