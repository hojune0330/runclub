      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2.5 sm:gap-4">
        ...
        <div className="col-span-3 space-y-4">
          ...
          {mode === 'tablet' ? (
            ...
            <Panel title="QR 코드" action={selectedSession ? `화면 갱신 ${timeLeft}초` : undefined}>
              {selectedSession ? (
                <div className="p-8 flex flex-col items-center">
                  ...
                  {checkinUrl && (
                    <p className="max-w-[420px] text-center text-[12px] text-[var(--color-text-muted)] break-all mb-3">
